# Kafka Encrypt and mTLS Authentication
...
```bash
kafka-topics --bootstrap-server sathish.com:9093 --command-config client.properties --create --topic test-topic
```

- Kafka Console Producer

```bash
kafka-console-producer --bootstrap-server  sathish.com:9091 --producer.config client.properties  --topic test-topic
```

- Kafka Console Consumer

```bash
kafka-console-consumer --bootstrap-server  sathish.com:9091 --consumer.config client.properties --topic test- --from-beginning --group group_sathish1
```